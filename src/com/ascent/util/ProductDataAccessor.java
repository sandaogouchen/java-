...
public class ProductDataAccessor extends DataAccessor {
	...
	public void load() {
		...
		try {
			...
			BufferedReader inputFromFile1 = new BufferedReader(
				new InputStreamReader(new FileInputStream(PRODUCT_FILE_NAME), "UTF-8")
			);
			...
			BufferedReader inputFromFile2 = new BufferedReader(
				new InputStreamReader(new FileInputStream(USER_FILE_NAME), "UTF-8")
			);
	...
	public void save(User user) {
		...
		try {
			...
			FileOutputStream fos = new FileOutputStream(USER_FILE_NAME, true);
